...
exports.myAlert = exports.hideMe = void 0;

var hideMe = function hideMe(el) {
  if (el) el.parentElement.parentElement.removeChild(el.parentElement);
};

exports.hideMe = hideMe;

var myAlert = function myAlert(type, message) {
  var html = "<div class=\"alert-".concat(type, "\">\n    <div class=\"alert__text\"><p>").concat(message, "</p></div>\n    <div id=\"closeAlert\" onclick=\"hideMe(this)\" class=\"alert__close\">X</div>\n    </div>");
...
exports.timeFormatter = exports.timer = exports.removeChild = void 0;

var removeChild = function removeChild(el) {
  if (el) {
    var memberElement = el.parentElement.parentElement;
...
var timer = function timer(el) {
  var nextDate = Date.parse(el.getAttribute('data-date'));
  setInterval(function () {
    var now = Date.now(); // const remaining = nextDate - now;

    var remaining = nextDate - now > 0 ? nextDate - now : now - nextDate;
    ...
    if (now > nextDate) {
      el.style.color = 'red';
      el.textContent = "\u0627\u0644\u0627\u062E\u062A\u0628\u0627\u0631 \u0628\u062F\u0627 \u0645\u0646\u0630 ".concat(days >= 10 ? days : '0' + days, ":").concat(hours >= 10 ? hours : '0' + hours, ":").concat(min >= 10 ? min : '0' + min, ":").concat(seconds >= 10 ? seconds : '0' + seconds);
    } else {
      el.textContent = "\u0627\u0644\u0627\u062E\u062A\u0628\u0627\u0631 \u0633\u064A\u0628\u062F\u0627 \u0628\u0639\u062F ".concat(days >= 10 ? days : '0' + days, ":").concat(hours >= 10 ? hours : '0' + hours, ":").concat(min >= 10 ? min : '0' + min, ":").concat(seconds >= 10 ? seconds : '0' + seconds);
...
var timeFormatter = function timeFormatter(time) {
  ...
  return mon + " ".concat(date.getDate(), ", ") + day + " ".concat(year);
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alert.myAlert)('danger', "".concat(_context.t0.response.data.message));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.myAlert)('danger', "".concat(_context2.t0.response.data.message));
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"createGroup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createGroup = exports.joinGroup = exports.showJoinGroup = exports.showCreateGroup = exports.closeMe = void 0;
...
exports.closeMe = closeMe;

var showCreateGroup = function showCreateGroup() {
  var joinModel = document.getElementById('createGroup');
  joinModel.style.display = 'block';
};

exports.showCreateGroup = showCreateGroup;

var showJoinGroup = function showJoinGroup() {
  var joinModel = document.getElementById('joinGroup');
  joinModel.style.display = 'block';
};

exports.showJoinGroup = showJoinGroup;

var joinGroup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(groupid, name, code) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post("http://localhost:3000/api/v1/groups/".concat(groupid, "/members/request"), {
              name: name,
              code: code
            });
          ...
          case 3:
            ...
            if (res.data.status === 'Success') {
              (0, _alert.myAlert)('success', 'Request sent successfully');
            }
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.myAlert)('danger', "Please try again later");
  ...
  return function joinGroup(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var createGroup = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.post("http://localhost:3000/api/v1/groups", {
              name: name
            });
          ...
          case 3:
            ...
            if (res.data.status === 'Success') {
              (0, _alert.myAlert)('success', 'Group created successfully');
            }
  ...
  return function createGroup(_x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.createGroup = createGroup;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"members.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeMember = exports.acceptMember = void 0;
...
var acceptMember = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(memberid) {
    var groupid, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _axios.default.post("http://localhost:3000/api/v1/groups/".concat(groupid, "/members/accept/").concat(memberid));

          case 4:
            res = _context.sent;

            if (res.data.status === "Success") {
              (0, _alert.myAlert)('success', 'Member accepted');
            }
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.myAlert)('danger', "Error, Please try again later");
  ...
  return function acceptMember(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var removeMember = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(memberid) {
    var groupid, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            groupid = window.location.pathname.split('/')[2];
            _context2.next = 4;
            return _axios.default.delete("http://localhost:3000/api/v1/groups/".concat(groupid, "/members/delete/").concat(memberid));

          case 4:
            res = _context2.sent;

            if (res.data.status === "Success") {
              (0, _alert.myAlert)('success', 'Member was deleted');
            }
  ...
  return function removeMember(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.removeMember = removeMember;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"quiz.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeQuiz = exports.nextQuiz = void 0;
...
var nextQuiz = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(quizid) {
    var nextQuizDate, startsAt, endsAt, groupid, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            nextQuizDate = document.forms['nextQuizDate'];
            startsAt = nextQuizDate.startsAt.value;
            endsAt = nextQuizDate.endsAt.value;
            groupid = window.location.pathname.split('/')[2];
            _context.prev = 4;
          ...
          case 11:
            _context.next = 13;
            return _axios.default.patch("http://localhost:3000/api/v1/groups/".concat(groupid, "/quiz/").concat(quizid, "/next"), {
              startsAt: startsAt,
              endsAt: endsAt
            });
          ...
          case 13:
            ...
            if (res.data.status === "Success") {
              (0, _alert.myAlert)('success', 'The quiz is now in the next list');
            }
          ...
          case 17:
            ...
            (0, _alert.myAlert)('danger', _context.t0);
  ...
  return function nextQuiz(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.nextQuiz = nextQuiz;

var removeQuiz = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(quizid, element) {
    var groupid, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            groupid = window.location.pathname.split('/')[2];
            _context2.next = 4;
            return _axios.default.delete("http://localhost:3000/api/v1/groups/".concat(groupid, "/quiz/").concat(quizid));

          case 4:
            res = _context2.sent;

            if (res.data.status === "success") {
              (0, _alert.myAlert)('success', 'Quiz was deleted');
            }

            (0, _utils.removeChild)(element);
            _context2.next = 12;
            break;
          ...
          case 9:
            _context2.prev = 9;
            _context2.t0 = _context2["catch"](0);
            (0, _alert.myAlert)('danger', _context2.t0);
  ...
  return function removeQuiz(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.removeQuiz = removeQuiz;
},{"./alert":"alert.js","./utils":"utils.js","axios":"../../node_modules/axios/index.js"}],"answer.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.finishQuiz = void 0;
...
var finishQuiz = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(quizid, answers) {
    var groupid, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            groupid = window.location.pathname.split('/')[2];
            _context.next = 4;
            return _axios.default.patch("http://localhost:3000/api/v1/groups/".concat(groupid, "/quiz/").concat(quizid, "/answer"), {
              answers: answers
            });
          ...
          case 4:
            ...
            if (res.data.status === 'Success') {
              location.assign("/groups/".concat(groupid, "/quiz/").concat(quizid, "/answer"));
            }
  ...
  return function finishQuiz(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.finishQuiz = finishQuiz;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"excel.js":[function(require,module,exports) {
"use strict";
...
var exportToExcel = function exportToExcel() {
  ...
  var tab = document.getElementById('member_table');
  var tableHTML = tab.outerHTML.replace(/ /g, '%20');
...
exports.vote = exports.createComment = exports.loadComments = exports.createPost = exports.getGroupPosts = void 0;
...
// -- For Posts --  //
var pushPost = function pushPost(element, post, user, where) {
  var html = "<div class=\"post mb-1\">\n            <div class=\"post__info\">\n                <img src=\"/img/user.jpg\" alt=\"user profile\" class=\"post__info-photo\">\n\n                <div class=\"post__info-cont\">\n                    <div class=\"post__info-names\">\n                        <h4><a href=\"#\" class=\"post__info-link\">".concat(user.name, "</a></h4>\n                        ").concat(post.groupId ? "<h4 class=\"post__info-postedIn pl1 pr1\">></h4>\n                        <h4><a href=\"/groups/".concat(post.groupId._id, "\" class=\"post__info-link\">").concat(post.groupId.name, "</a></h4>") : '', "\n                    </div>\n                    <a href=\"#\" class=\"post__info-date\">").concat((0, _utils.timeFormatter)(post.createdAt), "</a>\n                </div>    \n            </div>\n\n            <div class=\"post__content\">\n                <p class=\"post__content-post\">").concat(post.content, "</p>\n            </div>\n\n        \n            <div class=\"post__social\" id=\"").concat(post._id, "vote\" ").concat(post.groupId ? "data-groupId=\"".concat(post.groupId._id, "\"") : '', " data-postId=\"").concat(post._id, "\">\n                <div class=\"post__social-react ").concat(post.voted ? 'post__social-active' : '', " ml-1\" id=\"vote\">Vote (").concat(post.votes ? post.votes.length : 0, ")</div>\n                <div class=\"post__social-react ml-1\" id=\"postComment\">Comment (").concat(post.countComments || 0, ")</div>\n            </div>\n\n            <div class=\"post__comments\" data-page=\"1\" data-postId=\"").concat(post._id, "\" id=\"").concat(post._id, "Comments\">\n                <form class=\"form\" ").concat(post.groupId ? "data-groupId=\"".concat(post.groupId._id, "\"") : '', ">\n                    <div class=\"form__group\">\n                        <input type=\"text\" class=\"form-input w80 mb-0\" name=\"comment\" placeholder=\"\u0627\u0643\u062A\u0628 \u062A\u0639\u0644\u064A\u0642\u0643 \u0647\u0646\u0627\">\n                        <button type=\"submit\" id=\"createcommentForm\" class=\"btn w10\">\u062A\u0639\u0644\u064A\u0642</button>\n                    </div>\n                </form>\n            </div>\n\n        </div>");
  element.insertAdjacentHTML(where, html);
};

var getGroupPosts = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = _args.length > 0 && _args[0] !== undefined ? _args[0] : false;
            ...
            _context.next = 6;
            return _axios.default.post("http://localhost:3000/api/v1/groups/".concat(id, "/posts?page=").concat(page));
          ...
          case 9:
            _context.next = 11;
            return _axios.default.post("http://localhost:3000/api/v1/groups/posts?page=".concat(page));
          ...
          case 12:
            if (res.data.status === 'Success') {
              ...
              data.forEach(function (post) {
                post['voted'] = false;
                var voted = post.votes.findIndex(function (vote) {
          ...
          case 15:
            ...
            (0, _alert.myAlert)('danger', 'There is an error, Please try again later');
...
var createPost = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(post) {
    var feed, id, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            feed = document.getElementById('groupFeed');
            id = feed.getAttribute('data-id');
            _context2.next = 5;
            return _axios.default.post("http://localhost:3000/api/v1/groups/".concat(id, "/newpost"), {
              post: post
            });
...
var pushComments = function pushComments(element, comment, user, where) {
  var html = "<div class=\"post__comments_comment\">\n            <div class=\"post__comments-info\">\n                <img src=\"/img/user.jpg\" alt=\"user profile\" class=\"post__comments-info--photo\">\n\n                <div class=\"post__comments-info--cont\">\n                    <h5 class=\"mbn-1\"><a href=\"#\" class=\"post__comments-info--link\">".concat(user.name, "</a></h5>\n                    <a href=\"#\" class=\"link post__comments-info--date\">").concat((0, _utils.timeFormatter)(comment.createdAt), "</a>\n                </div>    \n            </div>\n\n            <div class=\"post__comments-content w90 mr-3\">\n                <p>").concat(comment.content, "</p>\n            </div>\n\n        </div>");
  element.insertAdjacentHTML(where, html);
};

var loadComments = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(groupId, postId) {
    var postCommentsPlace, page, res, comments;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            postCommentsPlace = document.getElementById("".concat(postId, "Comments"));
            page = parseInt(postCommentsPlace.getAttribute('data-page'));
            console.log(page);
            _context3.next = 6;
            return _axios.default.get("http://localhost:3000/api/v1/groups/".concat(groupId, "/post/").concat(postId, "/comment?page=").concat(page));
  ...
  return function loadComments(_x2, _x3) {
...
var createComment = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(id, postId, comment) {
    var res, postCommentsPlace;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _axios.default.post("http://localhost:3000/api/v1/groups/".concat(id, "/post/").concat(postId, "/comment"), {
              comment: comment
            });
...
var vote = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(groupId, postId) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return _axios.default.post("http://localhost:3000/api/v1/groups/".concat(groupId, "/post/").concat(postId, "/vote"));

          case 3:
            res = _context5.sent;

            if (res.data.status === 'Success') {
              document.getElementById("".concat(postId, "vote")).children[0].classList.toggle('post__social-active');
            }
...
exports.vote = vote;
},{"./alert":"alert.js","./utils":"utils.js","axios":"../../node_modules/axios/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
// Next quiz timer
var nextQuizElement = document.getElementById('quizStartsAt');

if (nextQuizElement) {
  (0, _utils.timer)(nextQuizElement);
} // Export Excel
...
if (exportExcel) {
  exportExcel.addEventListener('click', _excel.exportToExcel);
} // Login Form
...
var joinForm = document.forms['joinGroup'];

if (joinForm) {
  joinForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var groupid = joinForm.groupid.value;
    var name = joinForm.name.value;
    var code = joinForm.code.value;

    if (groupid && name && code) {
      (0, _createGroup.joinGroup)(groupid, name, code);
    } else {
      (0, _alert.myAlert)('danger', 'Please fill all inputs');
    }
  });
} // Join group MODAL
// Close
...
var closeJoinModel = document.getElementById('closeJoin');

if (closeJoinModel) {
  closeJoinModel.addEventListener('click', function () {
    (0, _createGroup.closeMe)(closeJoinModel);
  });
} // Show


var showJoinGroupModel = document.getElementById('showJoinGroupModel');

if (showJoinGroupModel) {
  showJoinGroupModel.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _createGroup.showJoinGroup)();
  });
} // Create group


var createForm = document.forms['createGroup'];

if (createForm) {
  createForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var groupName = createForm.groupName.value;

    if (groupName) {
      (0, _createGroup.createGroup)(groupName);
    } else {
      (0, _alert.myAlert)('danger', 'Please enter group name');
    }
  });
} // Create group MODAL
// Close
...
var closeCreateModel = document.getElementById('closeCreate');

if (closeCreateModel) {
  closeCreateModel.addEventListener('click', function () {
    (0, _createGroup.closeMe)(closeCreateModel);
  });
} // Show


var showCreateGroupModel = document.getElementById('showCreateGroupModel');

if (showCreateGroupModel) {
  showCreateGroupModel.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _createGroup.showCreateGroup)();
  });
...
if (members) {
  members.addEventListener('click', function (e) {
    ...
    if (targetId === "accept") {
      ...
      (0, _members.acceptMember)(id);
      (0, _utils.removeChild)(e.target);
    } else if (targetId === "remove") {
      var _id = e.target.getAttribute('data-id');

      (0, _members.removeMember)(_id);
      (0, _utils.removeChild)(e.target);
    }
  });
...
if (quizzes) {
  quizzes.addEventListener('click', function (e) {
    var targetId = e.target.id;
    ...
    if (targetId === "nextQuiz") {
      ...
      (0, _quiz.removeQuiz)(_id2, e.target);
    }
  });
} // Finish Answering Quiz


var answerForm = document.forms['answer_form'];
...
if (answerForm) {
  answerForm.addEventListener('submit', function (e) {
    ...
    (0, _answer.finishQuiz)(answerForm.getAttribute('data-id'), data);
  });
}
/*
    const getPostsFunc = () => {
...
var groupFeed = document.getElementById('groupFeed'); // Get Posts

var loadPosts = function loadPosts() {
  var groupid = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  groupid ? (0, _post.getGroupPosts)(groupid, page) : (0, _post.getGroupPosts)(false, page);
};

var commentFunc = function commentFunc(e, groupid) {
  var targetId = e.target.id;
  ...
  if (targetId === "postComment") {
    ...
    (0, _post.loadComments)(groupid, e.target.parentNode.getAttribute('data-postId'));
  } else if (targetId === "createcommentForm") {
    ...
    form.addEventListener('submit', function (e) {
      ...
      if (comment) {
        ...
        (0, _post.createComment)(groupid, form.parentNode.getAttribute('data-postId'), comment);
      }
...
var voteFunc = function voteFunc(e, groupid) {
  var targetId = e.target.id;
  ...
  if (targetId === "vote") {
    ...
    (0, _post.vote)(groupid, e.target.parentNode.getAttribute('data-postId'));
  }
};
...
if (groupFeed) {
  var groupid = groupFeed.getAttribute('data-id');
  loadPosts(groupid);
